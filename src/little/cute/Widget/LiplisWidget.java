...
import little.cute.Activity.LiplisWidgeSelecter;
  ...
  /// <summary>
    ...
    protected void runLiplis(AppWidgetManager appWidgetManager, Context context)
    {
        try
    	{
        	...
        	//たち絵をデフォルトに戻す？
        	//returnDefaultBody();
        	returnDefaultBody(appWidgetManager, context);
    ...
    /// まばたきカウントの取得
    /// </summary>
    protected void returnDefaultBody(AppWidgetManager appWidgetManager, Context context)
    {
        try
    	{
            //--- キャンセルフェーズ --------------------
